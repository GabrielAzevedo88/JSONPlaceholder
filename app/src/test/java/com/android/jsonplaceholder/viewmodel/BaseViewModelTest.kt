...
class BaseViewModelTest {
    ...
    fun `when you instantiate the viewModel then these are the initial values`() {
        sut.run {
            ...
            Assert.assertEquals(View.GONE, deletingLoaderVisibility.value)
        }
    }
    ...
    @Test
    fun `when I'm deleting the content then these are the expected values`() {
        sut.run {
            ...
            Assert.assertEquals(View.GONE, contendVisibility.value)
            Assert.assertEquals(View.GONE, errorVisibility.value)
            Assert.assertEquals(View.VISIBLE, deletingLoaderVisibility.value)
        }
    }
}